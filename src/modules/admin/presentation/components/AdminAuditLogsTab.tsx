              ...
              <tbody className="divide-y divide-gray-100">
                {auditLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50/70">
                    ...
                    <td className="px-4 py-3 font-semibold text-gray-700">{log.entity_type}</td>
                    <td className="px-4 py-3 font-mono text-gray-900">{log.entity_id}</td>
                    <td className="px-4 py-3 text-gray-600 font-mono text-[11px]">{log.performed_by}</td>
                    <td className="px-4 py-3 text-gray-700 max-w-xs truncate">{log.reason}</td>
                  </tr>
                ))}
              </tbody>
            </table>
