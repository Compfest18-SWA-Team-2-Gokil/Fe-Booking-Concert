    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Jelaskan detail event, lineup artis, atau informasi penting lainnya..."
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-bold text-gray-900 mb-1.5">Tanggal Pelaksanaan *</label>
          <input
            type="date"
            required
            value={date}
      ...
      <div>
        ...
        <input
          ...
          placeholder="cth. Gelora Bung Karno, Jakarta Pusat"
          className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#0064D2] text-sm"
        />
      </div>
      ...
      <div>
        ...
        {previewSrc ? (
          <div className="relative rounded-2xl overflow-hidden border border-gray-200 mb-3">
            <img src={previewSrc} alt="Preview Poster" loading="lazy" className="w-full h-48 object-cover" />
            <button
              type="button"
      ...
      <div className="flex gap-3 pt-4 border-t border-gray-100">
        ...
        <button
          ...
          className="flex-1 bg-[#0064D2] hover:bg-[#0052B0] text-white font-bold py-3.5 rounded-xl text-sm transition-colors shadow-md cursor-pointer disabled:opacity-50"
        >
          {isSubmitting ? 'Membuat Event...' : 'Buat Event & Lanjut'}
        </button>
      </div>
    </form>
  );
